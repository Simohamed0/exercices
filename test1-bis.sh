...
# Note : script contenant qq tests de plus que ceux donnés aux étudiants
...
tester ()
{
	...
	|| fail "erreur de z33-cli => regarder $TMP.in, $TMP.1 et $TMP.2"
}
...
verifier ()
{
    ...
    [ x"$v" = x"$val" ] || fail "$msg, valeur trouvée = $v (attendue = $val) pour registre %$reg => regarder $TMP.in et $TMP.1"
}
...
echo -n "Testsup 3 - Test 'calcul'......................................"
tester  "ld 7000,%sp" "ld 314159,%b" "push -3" "push 19" "call calcul" "reset"
verifier a 466   "calcul incorrect dans A"
verifier b 314159  "registre B non restauré"
verifier sp 6998 "registre SP non restauré"
echo OK
...
echo -n "Testsup 4 - Test 'prodscal' 3.................................."
tester "ld 7000,%sp" "ld 314159,%b" "push 0" "push testv2" "push testv1" \
	"call prodscal" "reset" \
	"testv2:" ".word 5" \
	"testv1:" ".word 5"
verifier a 0  "calcul incorrect dans A"
verifier b 314159   "registre B non restauré"
verifier sp 6997 "registre SP non restauré"
echo OK

echo -n "Testsup 4 - Test 'prodscal' 4.................................."
tester "ld 7000,%sp" "ld 314159,%b" "push 2" "push testv2" "push testv1" \
	"call prodscal" "reset" \
	"testv2:" ".word 5" ".word -2" \
	"testv1:" ".word 2" ".word 5"
verifier a 0  "calcul incorrect dans A"
verifier b 314159   "registre B non restauré"
verifier sp 6997 "registre SP non restauré"
echo OK
...
echo -n "Testsup 5 - Test 'racine' 3...................................."
tester  "ld 7000,%sp" "ld 314159,%b" "push 9999" "call racine" "reset"
verifier a 99   "calcul incorrect dans A"
verifier b 314159  "registre B non restauré"
verifier sp 6999 "registre SP non restauré"
echo OK

echo -n "Testsup 5 - Test 'racine' 4...................................."
tester  "ld 7000,%sp" "ld 314159,%b" "push 4" "call racine" "reset"
verifier a 2   "calcul incorrect dans A"
verifier b 314159  "registre B non restauré"
verifier sp 6999 "registre SP non restauré"
echo OK

echo -n "Testsup 5 - Test 'racine' 5...................................."
tester  "ld 7000,%sp" "ld 314159,%b" "push 2" "call racine" "reset"
verifier a 1   "calcul incorrect dans A"
verifier b 314159  "registre B non restauré"
verifier sp 6999 "registre SP non restauré"
echo OK
